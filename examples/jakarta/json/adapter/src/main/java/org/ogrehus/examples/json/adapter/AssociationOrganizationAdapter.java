	...
	JsonbAdapter<AssociationOrganization, JsonObject>
{
	...
	@Override
	public JsonObject adaptToJson(AssociationOrganization organization) {
	...
	@Override
	public AssociationOrganization adaptFromJson(JsonObject json) {
		return new AssociationOrganization() {
			@Override public Instant getFoundedDate() { return Instant.parse(json.getString("foundedDate")); }
		};
	}
}