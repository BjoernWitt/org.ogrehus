...
public interface Titleable {
	...
	/**
	 * Detects whether a value for title can be provided or not.
	 * 
	 * @return {@code true} if the value of title is not null and is no zerostring, otherwise {@code false}.
	 *  
	 */
	default boolean isTitleAvailable() {
