...
import org.ogrehus.gluttony.core.user.domain.api.model.info.UserInformation;
...
/**
 * This entity manages the consolidated user information.
 * 
 * @author Björn Witt
 * 
 */
...
extends
	  UserReadable<UserInformation, UserContact, PasswordReadable>
	, Contactable<UserContact>
	, UserModifiable
	, UUIdentifiable
	, Nameable
{
